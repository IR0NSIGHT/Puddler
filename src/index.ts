...
import {annotationColor, capRiverStart, pathRiverFrom, River} from "./pathing/river";
...
const main = () => {
    ...
    // DEBUG
    longRivers.map(r => r.path).forEach(r => applyRiverLayers(r, globalPonds, exportTargetRiver))
    // !DEBUG
